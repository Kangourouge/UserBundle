...
final class KRGUserEvents
{
     ...
     *
     * @Event("KRG\UserBundle\Event\GetResponseUserEvent")
     */
    const CHANGE_PASSWORD_INITIALIZE = 'krg_user.change_password.edit.initialize';
     ...
     *
     * @Event("KRG\UserBundle\Event\FormEvent")
     */
    const CHANGE_PASSWORD_SUCCESS = 'krg_user.change_password.edit.success';
     ...
     *
     * @Event("KRG\UserBundle\Event\FilterUserResponseEvent")
     */
    const CHANGE_PASSWORD_COMPLETED = 'krg_user.change_password.edit.completed';
     ...
     * This event allows you to modify the default values of the user before binding the form.
     *
     * @Event("KRG\UserBundle\Event\GroupEvent")
     */
    const GROUP_CREATE_INITIALIZE = 'krg_user.group.create.initialize';
     ...
     * @Event("KRG\UserBundle\Event\FormEvent")
     */
    const GROUP_CREATE_SUCCESS = 'krg_user.group.create.success';
     ...
     * This event allows you to access the response which will be sent.
     *
     * @Event("KRG\UserBundle\Event\FilterGroupResponseEvent")
     */
    const GROUP_CREATE_COMPLETED = 'krg_user.group.create.completed';
     ...
     * @Event("KRG\UserBundle\Event\FilterGroupResponseEvent")
     */
    const GROUP_DELETE_COMPLETED = 'krg_user.group.delete.completed';
     ...
     * This event allows you to modify the default values of the user before binding the form.
     *
     * @Event("KRG\UserBundle\Event\GetResponseGroupEvent")
     */
    const GROUP_EDIT_INITIALIZE = 'krg_user.group.edit.initialize';
     ...
     * @Event("KRG\UserBundle\Event\FormEvent")
     */
    const GROUP_EDIT_SUCCESS = 'krg_user.group.edit.success';
     ...
     * @Event("KRG\UserBundle\Event\FilterGroupResponseEvent")
     */
    const GROUP_EDIT_COMPLETED = 'krg_user.group.edit.completed';
     ...
     * @Event("KRG\UserBundle\Event\GetResponseUserEvent")
     */
    const PROFILE_EDIT_INITIALIZE = 'krg_user.profile.edit.initialize';
     ...
     * @Event("KRG\UserBundle\Event\FormEvent")
     */
    const PROFILE_EDIT_SUCCESS = 'krg_user.profile.edit.success';
     ...
     * @Event("KRG\UserBundle\Event\FilterUserResponseEvent")
     */
    const PROFILE_EDIT_COMPLETED = 'krg_user.profile.edit.completed';
     ...
     * This event allows you to modify the default values of the user before binding the form.
     *
     * @Event("KRG\UserBundle\Event\UserEvent")
     */
    const REGISTRATION_INITIALIZE = 'krg_user.registration.initialize';
     ...
     * @Event("KRG\UserBundle\Event\FormEvent")
     */
    const REGISTRATION_SUCCESS = 'krg_user.registration.success';

    /**
     * The REGISTRATION_FAILURE event occurs when the registration form is not valid.
     *
     * This event allows you to set the response instead of using the default one.
     * The event listener method receives a KRG\UserBundle\Event\FormEvent instance.
     *
     * @Event("KRG\UserBundle\Event\FormEvent")
     */
    const REGISTRATION_FAILURE = 'krg_user.registration.failure';
     ...
     * @Event("KRG\UserBundle\Event\FilterUserResponseEvent")
     */
    const REGISTRATION_COMPLETED = 'krg_user.registration.completed';
     ...
     * @Event("KRG\UserBundle\Event\GetResponseUserEvent")
     */
    const REGISTRATION_CONFIRM = 'krg_user.registration.confirm';
     ...
     * @Event("KRG\UserBundle\Event\FilterUserResponseEvent")
     */
    const REGISTRATION_CONFIRMED = 'krg_user.registration.confirmed';
     ...
     * The event listener method receives a KRG\UserBundle\Event\GetResponseUserEvent instance.
     *
     * @Event("KRG\UserBundle\Event\GetResponseUserEvent")
     */
    const RESETTING_RESET_REQUEST = 'krg_user.resetting.reset.request';
     ...
     * @Event("KRG\UserBundle\Event\GetResponseUserEvent")
     */
    const RESETTING_RESET_INITIALIZE = 'krg_user.resetting.reset.initialize';
     ...
     * @Event("KRG\UserBundle\Event\FormEvent ")
     */
    const RESETTING_RESET_SUCCESS = 'krg_user.resetting.reset.success';
     ...
     * @Event("KRG\UserBundle\Event\FilterUserResponseEvent")
     */
    const RESETTING_RESET_COMPLETED = 'krg_user.resetting.reset.completed';
     ...
     * @Event("KRG\UserBundle\Event\UserEvent")
     */
    const SECURITY_IMPLICIT_LOGIN = 'krg_user.security.implicit_login';
     ...
     * The event listener method receives a KRG\UserBundle\Event\GetResponseNullableUserEvent instance.
     *
     * @Event("KRG\UserBundle\Event\GetResponseNullableUserEvent")
     */
    const RESETTING_SEND_EMAIL_INITIALIZE = 'krg_user.resetting.send_email.initialize';
     ...
     * @Event("KRG\UserBundle\Event\GetResponseUserEvent")
     */
    const RESETTING_SEND_EMAIL_CONFIRM = 'krg_user.resetting.send_email.confirm';
     ...
     * @Event("KRG\UserBundle\Event\GetResponseUserEvent")
     */
    const RESETTING_SEND_EMAIL_COMPLETED = 'krg_user.resetting.send_email.completed';
     ...
     * @Event("KRG\UserBundle\Event\UserEvent")
     */
    const USER_CREATED = 'krg_user.user.created';
     ...
     * @Event("KRG\UserBundle\Event\UserEvent")
     */
    const USER_PASSWORD_CHANGED = 'krg_user.user.password_changed';
     ...
     * @Event("KRG\UserBundle\Event\UserEvent")
     */
    const USER_ACTIVATED = 'krg_user.user.activated';
     ...
     * @Event("KRG\UserBundle\Event\UserEvent")
     */
    const USER_DEACTIVATED = 'krg_user.user.deactivated';
     ...
     * @Event("KRG\UserBundle\Event\UserEvent")
     */
    const USER_PROMOTED = 'krg_user.user.promoted';
     ...
     * @Event("KRG\UserBundle\Event\UserEvent")
     */
    const USER_DEMOTED = 'krg_user.user.demoted';
}
